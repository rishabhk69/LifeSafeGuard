          ...
          if(profileState is ProfileLoadingState){
            ...
            return  Column(
              children: [
                      ...
                      children: [
                         CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                             AppConfig.IMAGE_BASE_URL + (profileState.profileModel.profilePhotoUrl??"")), // Replace with actual image
                        ),
                        Positioned(
                            top: 3,
                            right: 1,
                ...
                // Grid of Posts
                (profileState.profileModel.incidents??[]).isEmpty ? SizedBox():
                GridView.builder(
                  shrinkWrap: true,
                  ...
                  itemCount: profileState.profileModel.incidents?.length,
                  // Number of posts
                  itemBuilder: (context, index) {
                    return profileState.profileModel.incidents?[index].isVideo=="true" ? Container(
                      decoration: BoxDecoration(
                        // image: DecorationImage(
                          // image: NetworkImage(
                          //   AppConfig.VIDEO_BASE_URL+
                          //       (profileState.profileModel.incidents?[index].media![0].name??"").toString(),
                          // ),
                          // fit: BoxFit.cover,
                        // ),
            ...
            return Center(
              child: Text(profileState.errorMsg),
            );
          }
          return Container();
        })
