...
void showCommentsBottomSheetUser(BuildContext context, ProfileModel incidentsModel,int index) {
                          ...
                          children: [
                            ...
                            listener: (context,postListener){
                              if(postListener is PostCommentLoadingState){
                                ...
                                BlocProvider.of<CommentsBloc>(context).add(CommentsRefreshEvent(20, 0, incidentsModel.incidents?[index].incidentId));
                              }
                                ...
                                if(commentsController.text.trim().isNotEmpty){
                                  AppUtils().getUserData().then((onValue){
                                    ...
                                    BlocProvider.of<PostCommentBloc>(context).add(PostCommentRefreshEvent(
                                        ...
                                        incidentId:incidentsModel.incidents?[index].incidentId
                                    ));
                                  });
